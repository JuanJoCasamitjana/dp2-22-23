...
public interface LecturerLectureTestRepository extends AbstractRepository {
	...
	@Query("SELECT l FROM Lecture l WHERE l.lecturer.userAccount.username = :username AND l.published = false")
	Collection<Lecture> findNotPublishedLecturesByLecturerUname(String username);
