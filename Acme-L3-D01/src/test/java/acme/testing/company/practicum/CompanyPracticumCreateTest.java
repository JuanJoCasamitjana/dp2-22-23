...
public class CompanyPracticumCreateTest extends TestHarness {
	...
	public void test100Positive(final int recordIndex, final String code, final String title, final String abstractMessage, final String goals, final String estimatedTotalTime, final String published, final String course) {
	...
	public void test200Negative(final int recordIndex, final String code, final String title, final String abstractMessage, final String goals, final String estimatedTotalTime, final String published, final String course) {
