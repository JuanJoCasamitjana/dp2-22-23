...
public class AuditorAuditingRecordUpdateService extends AbstractService<Auditor, AuditingRecord> {
	...
	public void bind(final AuditingRecord object) {
		...
		super.bind(object, "audit.code", "subject", "assessment", "startDate", "endDate", "mark", "optionalLink");
	...
	public void unbind(final AuditingRecord object) {
		...
		tuple = super.unbind(object, "audit.code", "subject", "assessment", "startDate", "endDate", "mark", "optionalLink");
