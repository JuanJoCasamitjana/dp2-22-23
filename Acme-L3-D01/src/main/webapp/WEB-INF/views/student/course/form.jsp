...
<acme:input-textbox code="student.course.form.label.code" path="code"/>
	...
	<acme:input-textarea code="student.course.form.label.abstractMessage" path="abstractMessage"/>
	<acme:input-double code="student.course.form.label.retailPrice" path="retailPrice"/>
	<acme:input-select code="student.course.form.label.typeOfCourse" path="typeOfCourse" choices="${types}"/>
	<acme:input-url code="student.course.form.label.optionalUrl" path="optionalUrl"/>	
	<acme:input-checkbox code="student.course.form.label.inDraft" path="inDraft"/>	
