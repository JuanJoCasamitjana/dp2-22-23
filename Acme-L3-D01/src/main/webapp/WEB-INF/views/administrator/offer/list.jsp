...
<acme:list>
	...
	<acme:list-column code="administrator.offer.list.label.periodStart" path="periodStart"/>
	<acme:list-column code="administrator.offer.list.label.periodEnd" path="periodEnd"/>
